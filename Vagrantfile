...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.network :forwarded_port, guest: 69, host: 2269, id: "tftp", protocol: "udp", auto_correct: true
   config.vm.synced_folder "../data", "/vagrant_data"
   config.vm.provision :shell, path: "cbootstrap.sh"
